...
const Banner = () => {
  ...
  return (
    <div className="flex justify-center py-12 bg-base-100 dark:bg-gray-900 dark:text-white">
      <div className="w-full md:w-[80%]">
        ...
        >
          {slides.map((slide) => (
            <div
              key={slide._id}
              className="flex w-full h-[330px] md:h-[420px] rounded-xl overflow-hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
            >
              {/* Left Text */}

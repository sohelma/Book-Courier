    ...
    <div className="navbar bg-base-100 shadow-sm px-2 lg:px-6 sticky top-0 z-50 w-[96%] mx-auto rounded-xl">
      ...
      <div className="navbar-end flex items-center gap-3">
        ...
        <label className="swap swap-rotate cursor-pointer">
          ...
          {/* sun */}
          <svg className="swap-on h-6 w-6" xmlns="http://www.w3.org/2000/svg"
          ...
          {/* moon */}
          <svg className="swap-off h-6 w-6" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 24 24" fill="currentColor">
  ...
  <>
    <div className="avatar">
      <div className="w-10 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
        <img src={user.photoURL || "https://i.pravatar.cc/300"} alt="user" />
      </div>
    </div>
    <button onClick={handleLogout} className="btn btn-primary btn-sm ml-2">
      Logout
    </button>
  </>
) : (
